...
public class HelloWorld extends PApplet {
	 ...
	 * background. Feel free to copy and use this code, adding to it, modifying it,
	 * etc. Don't forget the import lines above.
	 */
	...
	public void setup() {
		...
		// provider= new Google.GoogleTerrainProvider(); // google map
		provider = new OpenStreetMap.OpenStreetMapProvider(); // open street map
		...
		map2.zoomAndPanTo(zoomLevel, new Location(35.26f, 139.68f));
